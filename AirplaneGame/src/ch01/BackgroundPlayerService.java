...
public class BackgroundPlayerService implements Runnable{
   ...
   public BackgroundPlayerService(AirplanePlayer player) {
      this.player = player;
   ...
   public void run() {
      while (true) {
         ...
         Color bottomColor = new Color(image.getRGB(player.getX()+10 , player.getY()+60 ));
         Color highColor = new Color(image.getRGB(player.getX()+10 , player.getY()-10));
